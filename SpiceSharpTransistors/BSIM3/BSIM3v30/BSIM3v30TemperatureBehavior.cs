...
namespace SpiceSharp.Components.ComponentBehaviors
{
    ...
    /// </summary>
    public class BSIM3v30TemperatureBehavior : TemperatureBehavior
    {
        ...
        public override void Temperature(Circuit ckt)
        {
            ...
            else
            {
                ...
                if (bsim3.pParam.BSIM3leff <= 0.0)
                    throw new CircuitException($"bsim3.BSIM3v30: mosfet {bsim3.Name}, model {model.Name}: Effective channel length <= 0");
                bsim3.pParam.BSIM3weff = bsim3.BSIM3w - 2.0 * bsim3.pParam.BSIM3dw;
                if (bsim3.pParam.BSIM3weff <= 0.0)
                    throw new CircuitException($"bsim3.BSIM3v30: mosfet {bsim3.Name}, model {model.Name}: Effective channel width <= 0");

                bsim3.pParam.BSIM3leffCV = bsim3.BSIM3l - 2.0 * bsim3.pParam.BSIM3dlc;
                if (bsim3.pParam.BSIM3leffCV <= 0.0)
                    throw new CircuitException($"bsim3.BSIM3v30: mosfet {bsim3.Name}, model {model.Name}: Effective channel length for C-V <= 0");

                bsim3.pParam.BSIM3weffCV = bsim3.BSIM3w - 2.0 * bsim3.pParam.BSIM3dwc;
                if (bsim3.pParam.BSIM3weffCV <= 0.0)
                    throw new CircuitException($"bsim3.BSIM3v30: mosfet {bsim3.Name}, model {model.Name}: Effective channel width for C-V <= 0");
                ...
                if (bsim3.BSIM3checkModel())
                    throw new CircuitException($"Fatal error(s) detected during bsim3.BSIM3v3.3 parameter checking for {bsim3.Name} in model {model.Name}");
