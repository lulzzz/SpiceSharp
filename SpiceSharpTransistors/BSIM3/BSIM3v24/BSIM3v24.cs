...
namespace SpiceSharp.Components
{
    ...
    public class BSIM3v24 : Component
    {
        ...
        public BSIM3v24(Identifier name) : base(name, BSIM3pinCount)
        {
            RegisterBehavior(new BSIM3v24TemperatureBehavior());
            RegisterBehavior(new BSIM3v24LoadBehavior());
            RegisterBehavior(new BSIM3v24AcBehavior());
            RegisterBehavior(new BSIM3v24NoiseBehavior());
            RegisterBehavior(new BSIM3v24TruncateBehavior());
        }
