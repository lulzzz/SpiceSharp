...
namespace SpiceSharp.Components.ComponentBehaviors
{
    ...
    public class BSIM3v24NoiseBehavior : NoiseBehavior
    {
        ...
        /// <returns></returns>
        private double StrongInversionNoiseEval(double Vds, BSIM3v24Model model, BSIM3v24 here, double freq, double temp)
        {
            ...
            T2 = 1.0e8 * EffFreq * here.BSIM3Abulk * model.BSIM3cox
              * here.pParam.BSIM3leff * here.pParam.BSIM3leff;
            ...
            T7 = 1.0e8 * EffFreq * here.pParam.BSIM3leff
               * here.pParam.BSIM3leff * here.pParam.BSIM3weff;
